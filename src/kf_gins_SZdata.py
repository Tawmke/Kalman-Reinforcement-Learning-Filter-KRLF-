...
if __name__ == "__main__":
    ...
    """
    可选：SZ-20240728-1520-1641 SZ-20240729-1354-1451 SZ-20240729-1606-1716
    """
    Dataset = 'SZ-20240729-1354-1451/RTK'
    ...
    # 打印测量值
    plt.figure('Gro measurement')
    plt.plot(imufile.data_[:, 1:4])
    plt.legend([f'X', f'Y', f'Z'])
    plt.title('Gro measurement')
    plt.show()

    plt.figure('Acc measurement')
    plt.plot(imufile.data_[:, 0], imufile.data_[:, 4:7])
    plt.legend([f'X', f'Y', f'Z'])
    plt.title('ACC measurement')
    plt.show()
    ...
    f_nav = open(config['outputpath']+'/KF_GINS_Navresult_testing.nav', 'w')
